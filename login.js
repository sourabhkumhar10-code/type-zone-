// --- Login Logic ---
const returnUrl = getReturnUrl("index.html");

// If already logged in, go straight to the return URL or homepage
if (getCurrentUser()) {
  window.location.href = returnUrl;
}

const registerLink = document.querySelector(".text-brand[href='register.html']");
if (registerLink) {
  registerLink.setAttribute("href", `register.html?returnUrl=${encodeURIComponent(returnUrl)}`);
}
